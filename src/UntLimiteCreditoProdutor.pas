...
begin
    ...
    begin
        ...
        SQL.Add(' ORDER BY LIMITECREDITO.CODPRODUTOR, LIMITECREDITO.CODDISTRIB');
...
begin
    ...
    begin
        ...
        if Application.MessageBox(pchar('Deseja alterar o limite de crédito no valor de ' + FormatFloat(',0.00', SQLQryEXEC.FieldByName('LIMITECRED').AsCurrency) +' do produtor ' + DBEdit2.Field.Text + '.'  + #13#10 +
           'Para o novo valor de limite de crédito de '+ FormatFloat(',0.00', CrrncyEdtLIMITECRED.Value) + '.'), pchar('Aviso!'), MB_ICONQUESTION + MB_YESNO + +MB_DEFBUTTON2) = ID_NO then
            Abort;
...
begin
    ...
    end;    //carregar as imagens de layout em (C:\Projeto\Interface\cabecalho.bmp )
    try
        Image1.Picture.LoadFromFile('C:\Projeto\src\Interface\cabecalho.bmp');
        Image2.Picture.LoadFromFile('C:\Projeto\src\Interface\rodape.bmp');
    except
...
begin
    ...
    //Para enter ter a mesma função tab.
