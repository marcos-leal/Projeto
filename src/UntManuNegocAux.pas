...
var vbmMARCARREGISTRO : TBookmark;
begin

    vbmMARCARREGISTRO := FrmManutNegoc.ClntDtStLISTARNEGOC.GetBookmark;
    ...
    FrmManutNegoc.BttnLOCALIZARClick(Sender);

    try
        FrmManutNegoc.ClntDtStLISTARNEGOC.GotoBookmark(vbmMARCARREGISTRO);
        FrmManutNegoc.ClntDtStLISTARNEGOC.FreeBookmark(vbmMARCARREGISTRO);
    except
...
begin
    ...
    LblNUMNEGOC.Caption := 'Número da negociação: ' + FrmManutNegoc.ClntDtStLISTARNEGOCNUMNEGOC.AsString;

    case AnsiIndexStr(FrmManutNegoc.ClntDtStLISTARNEGOCSTATUS.AsString, ['Aprovado', 'Concluido', 'Cancelado']) of
        0:
